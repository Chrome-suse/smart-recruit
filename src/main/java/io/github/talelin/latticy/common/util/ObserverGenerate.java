...
public class ObserverGenerate {
    ...
    private static final String CLASS_PATH = System.getProperty("user.dir") + "/src/main/java/io/github/talelin/latticy/common/observer/user";
    ...
    public static void generate(String className) {
        ...
        try {
            ...
            dataMap.put("classPath", "io.github.talelin.latticy.common.observer.user");
